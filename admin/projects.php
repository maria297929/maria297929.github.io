                  ...
                  <table class="table tablesorter " id="">
                    <thead class=" text-primary">
                      <tr>
                        ...
                        <th>Image</th>
                        <th class="actions">
          <a href="add-project.php?" class="add"><i class="fas fa-plus-circle"></i></a>
                        </th>
                      </tr>
                    </thead> 
                    <tbody>
...
$num_projects = $pdo->query('SELECT COUNT(*) FROM projects')->fetchColumn();
 foreach ($projects as $project): ?>
  <tr>
      ...
      <td><img src="<?php echo $project['img']; ?>" width="100" height="100"></td>
      <td class="actions">
          <a href="edit-project.php?id=<?=$project['id']?>" class="edit"><i class="fas fa-pen fa-xs"></i></a>
          <a href="delete-projects.php?id=<?=$project['id']?>" class="trash"><i class="fas fa-trash fa-xs"></i></a>
      </td>
  </tr>
  <?php endforeach; ?>
                  </tbody>
		...
		<?php if ($page > 1): ?>
		<a href="projects.php?page=<?=$page-1?>"><i class="fas fa-angle-double-left fa-sm"></i></a>
		<?php endif; ?>
		<?php if ($page*$records_per_page < $num_projects): ?>
		<a href="projects.php?page=<?=$page+1?>"><i class="fas fa-angle-double-right fa-sm"></i></a>
		<?php endif; ?>
	  </div>
                </div>
              </div>
