...
if (isset($_GET['id'])) {
    ...
    if (isset($_GET['confirm'])) {
        if ($_GET['confirm'] == 'yes') {
            ...
            $stmt->execute([$_GET['id']]);
            $msg = 'You have deleted the project!';
        } else {
...
<div  class="home_content">
	<h2>Delete Project #<?=$project['id']?></h2>
    <?php if ($msg): ?>
    <p><?=$msg?></p>
    <?php else: ?>
	<p>Are you sure you want to delete project #<?=$project['id']?>?</p>
    <div class="yesno">
        <a href="delete-projects.php?id=<?=$project['id']?>&confirm=yes">Yes</a>
        <a href="delete-projects.php?id=<?=$project['id']?>&confirm=no">No</a>
    </div>
    <?php endif; ?>
</div>
<script>
